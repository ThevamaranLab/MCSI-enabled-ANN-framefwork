...
for p = 2:7
    x_c_vec(p) = 2*(r1+t)*cos((p-1)*pi/3);
    y_c_vec(p) = 2*(r1+t)*sin((p-1)*pi/3);
end
...
saveas(figure(1),'figure_nes1_1.jpg');
saveas(figure(2),'figure_nes1_2.jpg');
saveas(figure(3),'figure_nes1_3.jpg');
